      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; SISTEMA GERENCIAL - ELAPAS</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <script src="js/sb-admin-2.js"></script>
    ...
    <script type="text/javascript" src="js/metas.js"></script> 
    <script type="text/javascript" src="js/ejecucion.js"></script> 
    <script type="text/javascript" src="js/desc_areas.js"></script> 

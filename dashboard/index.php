    ...
    <div class="col-xl-8 col-lg-7">
        <div class="card shadow mb-4">
            ...
            <div
                ...
                <h6 class="m-0 font-weight-bold text-primary">METAS EJECUTADAS</h6>
            ...
            <form id="FormSelectArea">
                ...
                <select disabled class="form-control col-sm-6" onchange="mostrarGrafico(this.value);" name="area" id="selectArea">
                <?php                            
                    foreach($data as $dat) {                                                        
                    ?>
